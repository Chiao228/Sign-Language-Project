#!/usr/bin/env python3
"""
sliding_window_crop_81.py
=========================
滑窗裁切與過濾 (81D 版本 - 66D 手部座標 + 15D 身體座標)
描述：此腳本使用固定長度的滑窗 (Sliding Window) 遍歷 81 維特徵序列。
...
# ==========================================
SOURCE_DIR = Path("tsl_features_81")   # features_holistic_81.py 產出的 81 維資料
OUTPUT_DIR = Path("sliding_window_81") # 滑窗產出的輸出地
...
def main():
    print("=" * 60)
    print("🚀 啟動 81 維滑窗裁切 (Sliding Window) 處理管線")
